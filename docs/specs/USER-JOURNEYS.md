...
| [Operations & Configuration](journeys/operations-and-configuration.md) | Operator observability, development-mode auto-approve, JSON-based runtime configuration, and HTTPS for the gateway listener. | `J8`-`J10`, `J14` | 11 | `10 covered`, `1 partial`, `0 uncovered` |
